...
The DynamicConditions class is the root of the dynamic conditions hierarchy.
...
public abstract class DynamicConditions {

        public abstract ArrayList<TraceEvent> Met(ArrayList<TraceEvent> satisfyingEvents);
}
