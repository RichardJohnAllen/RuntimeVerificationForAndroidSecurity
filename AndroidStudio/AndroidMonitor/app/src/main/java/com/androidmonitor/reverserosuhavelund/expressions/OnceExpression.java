...
The OnceExpression class implements the evaluation of the LTL Once operator.
...
class OnceExpression extends UnaryExpression {

	public OnceExpression(String formula, OnceExpression previous) {
